...
import 'package:openwrt_manager/Page/Form/infoRequest.dart';
import 'package:openwrt_manager/Page/Form/meshTopology.dart';
...
import 'Form/authentification.dart';
...
class _MainPageState extends State<MainPage> with WidgetsBindingObserver {
  ...
  initVersionState() async {
    try {
      ...
      _appVersion = "1.20"; // currently there is an error on windows build
    }
  }
        ...
        child: Stack(children: <Widget>[
          Drawer(
              ...
              child: ListView(padding: EdgeInsets.zero, children: <Widget>[
                ...
                ListTile(
                  leading: Container(
                      width: drawerIconWidth, child: const Icon(Icons.device_hub)),
